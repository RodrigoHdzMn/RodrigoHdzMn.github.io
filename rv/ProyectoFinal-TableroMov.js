...
function PeonNegro(x=0,y=0,z=0){
	Agent.call(this,x,y,z);
	this.actuator = new THREE.Mesh(peonForma, Gris);
	this.actuator.commands = [];
	this.add(this.actuator);
	this.position.y=y;
	this.position.z=z;
...
function Referencia(x=0,y=0,z=0){
  Agent.call(this,x,y,z);
  var texturaReferencia = new THREE.MeshLambertMaterial({color: 0xFFFF00});
...
function setup(){
   ...
   luzPuntual2.position.y =25;
   luzPuntual2.position.z = 200;
