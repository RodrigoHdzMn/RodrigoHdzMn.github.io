...
{
      var arbol1= new TRHEE.Mesh( new PROTOTIPO.ArbolGeometry(),
                             new PROTOTIPO.MeshNormalMaterial());
      var arbol2= new TRHEE.Mesh( new PROTOTIPO.ArbolGeometry(),
                             new PROTOTIPO.MeshNormalMaterial());
...
PROTOTIPO.loop = function()
{
      ...
      CONSTRUCTOR.renderizador.render( PROTOTIPO.escena, PROTOTIPO.camara );
}
